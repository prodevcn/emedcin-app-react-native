...
export default class DoctorFirstScreen extends Component {
  constructor(props) {
    super(props);
  ...
  next() {
    if (JSON.stringify(this.state.password).length < 6) {
      Toast.show(
      ...
      let userInfo = {
        ...
        avatar: GLOBALS.DEFAULT_DOCTOR_AVATAR,
      };
      console.log(userInfo);
      this.props.navigation.navigate('DoctorSecond', {userInfo: userInfo});
    }
  }
  render() {
    return (
